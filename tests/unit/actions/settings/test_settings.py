...
from distronode_navigator.actions.settings import CONTENT_HEADING_DEFAULT
from distronode_navigator.actions.settings import CONTENT_HEADING_NOT_DEFAULT
from distronode_navigator.actions.settings import color_menu
from distronode_navigator.actions.settings import content_heading
from distronode_navigator.configuration_subsystem import PresentableSettingsEntry
from distronode_navigator.configuration_subsystem.defs_presentable import PresentableCliParameters
