...
from distronode_navigator.actions.exec import _generate_command
...
command_test_data = [
    ...
    CommandTestData(
        ...
        command="distronode-vault encrypt_string --vault-password-file"
        ...
        result_params=[
            "-c",
            "distronode-vault encrypt_string --vault-password-file"
            " a_password_file 'foobar' --name 'the_secret'",
        ],
    ),
    CommandTestData(
        ...
        use_shell=False,
        default_exec_command=False,
        result_command="distronode-vault",
        result_params=[
            "encrypt_string",
            "--vault-password-file",
            "a_password_file",
