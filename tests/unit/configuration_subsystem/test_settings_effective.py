...
from distronode_navigator.configuration_subsystem import SettingsFileType
from distronode_navigator.configuration_subsystem import SettingsSchemaType
...
def test_settings_cli():
    ...
    root = effective["distronode-navigator"]
...
def test_settings_full(
    ...
    type_check_only = [
        "distronode-navigator.distronode.inventory.entries",  # might be paths or not
    ]
