...
def config_post_process(expected: dict[str, Any], path: str) -> dict[str, Any]:
    ...
    """
    if path == "distronode-navigator.execution-environment.volume-mounts":
        parsed_volume_mounts = []
        volume_mounts = expected["distronode-navigator"]["execution-environment"]["volume-mounts"]
        ...
        expected["distronode-navigator"]["execution-environment"][
            "volume-mounts"
        ] = parsed_volume_mounts
