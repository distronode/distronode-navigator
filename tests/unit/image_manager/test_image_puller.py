...
from distronode_navigator.image_manager import ImagePuller
...
data_image_tag = [
    ("foo", "latest"),
    ("foo:bar", "bar"),
    ("registry.redhat.io:443/distronode-automation-platform-21/ee-supported-rhel8", "latest"),
    ("registry.redhat.io:443/distronode-automation-platform-21/ee-supported-rhel8:latest", "latest"),
]
