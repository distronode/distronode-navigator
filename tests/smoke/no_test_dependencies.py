...
class NavigatorCommand(Command):
    ...
    def __post_init__(self):
        ...
        venv = _get_venv()
        self.command = f". {venv} && distronode-navigator {self.command} {self.set_env}"
...
PartialCommands = (
    ...
    PartialCommand(params="builder --help-builder", find="Print distronode-builder version"),
    PartialCommand(params="config list --mode stdout", find="Valid YAML extensions"),
    PartialCommand(params="doc debug --mode stdout", find="distronode.builtin.debug"),
