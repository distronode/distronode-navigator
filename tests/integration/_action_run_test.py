...
from distronode_navigator.content_defs import ContentType
from distronode_navigator.steps import Steps
from distronode_navigator.ui_framework.ui import Action as Ui_action
from distronode_navigator.ui_framework.ui import Form
from distronode_navigator.ui_framework.ui import Interaction
from distronode_navigator.ui_framework.ui import Ui
...
class ActionRunTest:
    ...
    def __init__(
        ...
        :param pass_environment_variable: Any environment variables to pass into the
            execution environment
        :param private_data_dir: The artifact directory for distronode runner
        :param rotate_artifacts: The number of artifacts distronode runner should maintain
        :param timeout: The distronode runner timeout value
        """
        ...
        self._app_args = {
            ...
            "distronode_runner_artifact_dir": self._private_data_dir,
            "distronode_runner_rotate_artifacts_count": self._rotate_artifacts,
            "distronode_runner_timeout": self._timeout,
        }
        self._app_action = __import__(
            f"distronode_navigator.actions.{self._action_name}",
            globals(),
            fromlist=["Action"],
        )
