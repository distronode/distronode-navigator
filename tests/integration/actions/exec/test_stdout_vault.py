...
to distronode vault within the execution environment.
"""
...
VAULT_COMMAND = (
    "distronode-vault encrypt_string --vault-password-file a_password_file 'foobar'"
    " --name 'the_secret'"
)

BASE_COMMAND = "distronode-navigator --ll debug --la false"
