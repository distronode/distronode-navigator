...
# distronode-doc help with EE
CLI_DOC_HELP_WITH_EE = (
    "distronode-navigator doc company_name.coll_1.mod_1 --help-doc -m stdout"
...
testdata_1: list = [
    (
        0,
        CLI_DOC_HELP_WITH_EE,
        "distronode-navigator doc help with ee",
        "doc_help_with_ee",
        ["usage: distronode-doc [-h]"],
    ),
]
...
# distronode-doc help without EE
CLI_DOC_HELP_WITHOUT_EE = (
    "distronode-navigator doc company_name.coll_1.mod_1"
...
testdata_2: list = [
    (
        0,
        CLI_DOC_HELP_WITHOUT_EE,
        "distronode-navigator doc help without ee",
        "doc_help_without_ee",
        ["usage: distronode-doc [-h]"],
    ),
]
...
# distronode-doc help failed check in interactive mode
CLI_DOC_HELP_WITH_EE_INTERACTIVE_MODE = (
    "distronode-navigator doc company_name.coll_1.mod_1 --help-doc -m interactive"
    " --execution-environment true"
)
...
testdata_3: list = [
    (
        0,
        CLI_DOC_HELP_WITH_EE_INTERACTIVE_MODE,
        "distronode-navigator doc help with ee in interactive mode",
...
testdata_4: list = [
    (
        0,
        CLI_DOC_HELP_WITHOUT_EE_INTERACTIVE_MODE,
        "distronode-navigator doc help without ee in wrong mode",
        "doc_help_with_ee_wrong_mode",
        ["usage: distronode-doc [-h]"],
    ),
]
...
CLI_MODULE_DOC_WITHOUT_EE = (
    "distronode-navigator doc company_name.coll_1.mod_1 -m stdout -j --execution-environment false"
)
...
testdata_5: list = [
    (
        0,
        CLI_MODULE_DOC_WITHOUT_EE,
        "distronode-navigator doc in stdout mode without EE",
...
CLI_MODULE_DOC_WITH_EE = (
    "distronode-navigator doc company_name.coll_1.mod_1 -m stdout -j --execution-environment true"
)
...
testdata_6: list = [
    (
        0,
        CLI_MODULE_DOC_WITH_EE,
        "distronode-navigator doc in stdout mode with EE",
        "module_doc_with_ee",
        None,
    ),
]
...
CLI_LOOKUP_DOC_WITHOUT_EE = (
    "distronode-navigator doc company_name.coll_1.lookup_1 -t lookup -m stdout -j"
    " --execution-environment false"
)
...
testdata_7: list = [
    (
        0,
        CLI_LOOKUP_DOC_WITHOUT_EE,
        "distronode-navigator lookup doc in stdout mode without EE",
...
testdata_8: list = [
    (
        0,
        CLI_LOOKUP_DOC_WITH_EE,
        "distronode-navigator lookup doc in stdout mode with EE",
        "lookup_doc_with_ee",
        None,
    ),
]
...
CLI_FILTER_DOC_WITHOUT_EE = (
    "distronode-navigator doc company_name.coll_1.filter_1 -t filter -m stdout -j"
    " --execution-environment false"
)
...
testdata_9: list = [
    (
        0,
        CLI_FILTER_DOC_WITHOUT_EE,
        "distronode-navigator filter doc in stdout mode without EE",
...
testdata_10: list = [
    (
        0,
        CLI_FILTER_DOC_WITH_EE,
        "distronode-navigator filter doc in stdout mode with EE",
        "filter_doc_with_ee",
        None,
    ),
]
