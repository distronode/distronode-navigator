...
DISTRONODE_INVENTORY_FIXTURE_DIR = os.path.join(TEST_FIXTURE_DIR, "distronode_inventory", "inventory.yml")
TEST_CONFIG_FILE = os.path.join(TEST_FIXTURE_DIR, "distronode-navigator.yml")
...
class BaseClass:
    ...
    def test(self, request, tmux_session, step):
        ...
        """
        assert os.path.exists(DISTRONODE_INVENTORY_FIXTURE_DIR)
