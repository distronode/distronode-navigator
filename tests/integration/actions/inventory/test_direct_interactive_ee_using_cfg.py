"""Tests for inventory from CLI, interactive, with an EE, using distronode.cfg."""
...
class Test(BaseClass):
    """Run the tests for inventory from CLI, interactive, with an EE, using distronode.cfg."""
