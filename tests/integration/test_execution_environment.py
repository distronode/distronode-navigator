...
test_data = [
    ("defaults", "", "distronode-navigator_empty.yml", {"process_isolation": True}),
    ("set at command line", "--execution-environment false", "distronode-navigator_empty.yml", None),
    ("set in config file", "", "distronode-navigator_disable_ee.yml", None),
    (
        "set command line and config file, command line wins",
        "--execution-environment true",
        "distronode-navigator_disable_ee.yml",
