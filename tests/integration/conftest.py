...
def os_independent_tmp() -> str:
    ...
    otherwise distronode-navigator column widths can vary
...
class CliRunner:
    """A class to run distronode-navigator in a tty."""
    ...
    def to_cmdline(self) -> str:
        ...
        cli_parts = ["distronode-navigator"]
