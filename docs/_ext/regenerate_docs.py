...
from distronode_navigator.version import __version__
...
TEST_SETTINGS_FIXTURE = (
    ...
    / "distronode-navigator.yml"
)
DOCS_SETTINGS_SAMPLE = PROJECT_DIR / "docs" / ".generated" / "distronode-navigator.yml"
...
def _subcommands_overview() -> str:
    ...
    for subcommand in NavigatorConfiguration.subcommands:
        ...
        table.append(f"\n    CLI Example: `distronode-navigator {subcommand.name} --help`")
...
def md_settings_sample() -> str:
    ...
    not_commented = ["---", "distronode-navigator:", "logging:", "level:"]
