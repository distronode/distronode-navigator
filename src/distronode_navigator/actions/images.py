...
from distronode_navigator.image_manager import inspect_all
...
class Action(ActionBase):
    ...
    def _build_image_content(self) -> Step:
        ...
        if self.steps.current.index == 1:
            ...
            step = Step(
                name="distronode",
                step_type="content",
                value=self._images.selected["distronode"],
            )
    ...
    def _build_image_menu(self) -> Step:
        ...
        if self.steps.current.selected["execution_environment"]:
            ...
            menu.append(
                {
                    first_column: "Distronode version and collections",
                    "description": "Information about distronode and distronode collections",
                },
            )
            menu.append(
                {
    ...
    def _collect_image_list(self):
        ...
        for image in images:
            ...
            try:
                root_label_check = details["labels"]["distronode-execution-environment"] == "true"
            ...
            try:
                config_label_check = (
                    details["config"]["labels"]["distronode-execution-environment"] == "true"
                )
            except (KeyError, TypeError):
    ...
    def _introspect_image(self) -> bool:
        ...
        try:
            ...
            self._images.selected["distronode"] = {
                "distronode": {
                    "collections": parsed["distronode_collections"],
                    "version": parsed["distronode_version"],
                },
            }
