...
An instance of :class:`~distronode_navigator.action_runner.ActionRunner`
is invoked once, after settings are parsed. A loop is entered and only
exited when the user requests to quit.

After initializing the user interface, an :class:`~distronode_navigator.ui_framework.ui.Interaction`
...
from distronode_navigator.actions import kegexes
from distronode_navigator.actions import run_action
