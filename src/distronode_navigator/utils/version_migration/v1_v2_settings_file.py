...
from distronode_navigator.utils.dot_paths import MergeBehaviors
from distronode_navigator.utils.dot_paths import check_path
from distronode_navigator.utils.dot_paths import get_with_path
from distronode_navigator.utils.dot_paths import move_to_path
from distronode_navigator.utils.dot_paths import place_at_path
...
class V1V2SettingsFile(SettingsFile):
    ...
    def config_path(self) -> bool:
        ...
        """
        old_path = "distronode-navigator.distronode.config"
        new_path = "distronode-navigator.distronode.config.path"
    ...
    def documentation(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.documentation"
        new_path = "distronode-navigator.distronode.doc"
    ...
    def playbook_path(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.distronode.playbook"
        new_path = "distronode-navigator.distronode.playbook.path"
    ...
    def help_config(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.help-config"
        new_path = "distronode-navigator.distronode.config.help"
    ...
    def help_doc(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.help-doc"
        new_path = "distronode-navigator.distronode.doc.help"
    ...
    def help_inventory(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.help-inventory"
        new_path = "distronode-navigator.distronode.inventory.help"
    ...
    def help_playbook(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.help-playbook"
        new_path = "distronode-navigator.distronode.playbook.help"
    ...
    def inventories(self) -> bool:
        ...
        """
        old_path = "distronode-navigator.distronode.inventories"
        new_path = "distronode-navigator.distronode.inventory.entries"
    ...
    def playbook_artifact(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        path = "distronode-navigator.playbook-artifact.save-as"
    ...
    def pull_policy(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        old_path = "distronode-navigator.execution-environment.pull-policy"
        new_path = "distronode-navigator.execution-environment.pull.policy"
    ...
    def volume_mount_labels(self) -> bool:
        ...
        :returns: Whether the migration is needed
        """
        path = "distronode-navigator.execution-environment.volume-mounts"
